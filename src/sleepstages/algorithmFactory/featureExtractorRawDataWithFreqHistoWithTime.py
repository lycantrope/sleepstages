...
class FeatureExtractorRawDataWithFreqHistoWithTime(FeatureExtractor):
    def __init__(self):
        ...
        binNum4spectrum = round(self.wholeBand.band_width / params.binWidth4freqHisto)
        self.binArray4spectrum = np.linspace(
            self.wholeBand.bottom, self.wholeBand.top, binNum4spectrum + 1
        )
    ...
    def get_features(self, eegSegment, timeStampSegment, time_step):
        ...
        extractedPowerSpect = self.wholeBand.extractPowerSpectrum(
